...
namespace wineshop_off_shop
{
    public partial class show_profitandloss : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dt.Rows.Add("Opeing Stock  "+ope_ml+"ML",opening,0);
            dt.Rows.Add("Purchese Stock  " + pur_ml + "ML", purchase, 0);
            dt.Rows.Add("Sale " + sale_ml + "ML", 0, sale);
            dt.Rows.Add("Closing Stock " + clo_ml + "ML", 0, closing);
            purchase_amount = 0;
            opening_amount = 0;
            sale_amount = 0;
            closing_amount = 0;
            ...
            if (dr > cr)
            {
                dt.Rows.Add("To Loss","",dr-cr);
                dt.Rows.Add("Total",dr,dr);
            }
            else if (cr > dr)
            {
                dt.Rows.Add("To Profit", cr-dr,"");
                dt.Rows.Add("Total", cr, cr);
            }
