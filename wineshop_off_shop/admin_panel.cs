...
namespace wineshop_off_shop
{
    public partial class admin_panel : Form
    {
        ...
        {
           DialogResult dr = MessageBox.Show("Are You Sure TO Insert Opening Stock?Once You Insert opening stock you can not insert in this month again", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk);
